...
with_node \
  ...
  --target "/Users/trumanpurnell/Workspace/dinero/templat/ios/Pods/Target Support Files/Pods-templat/ExpoModulesProvider.swift" \
  --entitlement "/Users/trumanpurnell/Workspace/dinero/templat/ios/templat/templat.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
